...
function Deals(props) {
    ...
    return (
        <div className="deals" style={{ padding: "0px 20px 20px 20px",marginBottom:"20px", marginLeft:"auto", marginRight:"auto", width:"50%", borderRadius:"10px", borderWidth:"1px",borderStyle:"solid", height: "200px", overflow: "auto"}}>
